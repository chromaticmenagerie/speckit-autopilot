...
for script in autopilot.sh autopilot-lib.sh autopilot-stream.sh autopilot-prompts.sh autopilot-detect-project.sh autopilot-github.sh autopilot-github-sync.sh autopilot-review.sh autopilot-review-helpers.sh autopilot-merge.sh autopilot-design.sh autopilot-finalize.sh autopilot-verify.sh autopilot-gates.sh autopilot-requirements.sh autopilot-watch.sh autopilot-validate.sh common.sh codex-review-schema.json; do
