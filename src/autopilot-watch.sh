...
# ─── Constants & Globals ─────────────────────────────────────────────────────
PHASES=(specify clarify clarify-verify plan design-read tasks analyze analyze-verify implement verify-requirements security-review verify-ci review merge crystallize)
SPINNER_CHARS=(⠋ ⠙ ⠹ ⠸ ⠼ ⠴ ⠦ ⠧ ⠇ ⠏)
