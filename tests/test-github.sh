...
assert_eq "Todo"        "$(_gh_phase_to_status specify)"         "specify → Todo"
assert_eq "Todo"        "$(_gh_phase_to_status clarify)"         "clarify → Todo"
assert_eq "Todo"        "$(_gh_phase_to_status clarify-verify)"  "clarify-verify → Todo"
assert_eq "Todo"        "$(_gh_phase_to_status plan)"            "plan → Todo"
assert_eq "Todo"        "$(_gh_phase_to_status tasks)"           "tasks → Todo"
assert_eq "Todo"        "$(_gh_phase_to_status analyze)"         "analyze → Todo"
assert_eq "Todo"        "$(_gh_phase_to_status analyze-verify)"  "analyze-verify → Todo"
assert_eq "In Progress" "$(_gh_phase_to_status implement)"       "implement → In Progress"
assert_eq "In Progress" "$(_gh_phase_to_status review)"          "review → In Progress"
assert_eq "In Progress" "$(_gh_phase_to_status finalize-fix)"    "finalize-fix → In Progress"
